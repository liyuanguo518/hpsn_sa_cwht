...
filename = 'C_Difficult1_noise015.mat';
...
addpath 'C:\phd\006_Scale4Edge\matlab_data\mel_test\trifbank'
...
elseif fe_type==1
    trainSpikes8=kron(trainSpikes, ones(1,8));
    FE_mfcc = mfcc('0',trainSpikes8,512,64,24);
    trainFeature = FE_mfcc(:, n_fe_start:n_fe_step:(FE*n_fe_step+n_fe_start-1));
end

if dispEn
    figure(1);
    % scatter3(trainFeature(trueLabels==1,1), trainFeature(trueLabels==1,2), trainFeature(trueLabels==1,3), 'r*','Linewidth',1);
    scatter(trainFeature(trueLabels==1,1), trainFeature(trueLabels==1,2), 'r*','Linewidth',1);
    hold on;
    % scatter3(trainFeature(trueLabels==2,1), trainFeature(trueLabels==2,2), trainFeature(trueLabels==2,3), 'b*','Linewidth',1);
    scatter(trainFeature(trueLabels==2,1), trainFeature(trueLabels==2,2), 'b*','Linewidth',1);
...
elseif fe_type==1
    valSpikes8=kron(valSpikes, ones(1,8));
    FE_mfcc = mfcc('hann',valSpikes8,512,64,24);
    valFeature = FE_mfcc(:, n_fe_start:n_fe_step:(FE*n_fe_step+n_fe_start-1));
end
